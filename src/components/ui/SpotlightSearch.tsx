...
import type { DesktopItem, FolderItem } from '../../types'
        ...
        <div className="absolute inset-x-0 top-[15%] flex justify-center px-4">
          ...
          >
            ...
            <div className="px-4 py-2 border-t border-white/10 flex gap-4 text-[10px] text-white/25">
              <span>
                <kbd className="bg-white/10 px-1 rounded">↑↓</kbd> Navigieren
              </span>
              <span>
                <kbd className="bg-white/10 px-1 rounded">Enter</kbd> Öffnen
              </span>
              <span>
                <kbd className="bg-white/10 px-1 rounded">Esc</kbd> Schließen
              </span>
            </div>
          </motion.div>
        </div>
